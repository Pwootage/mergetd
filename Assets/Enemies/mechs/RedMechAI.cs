...
[Serializable]
public class RedMechEffect
{
    public float slowMultiplier = 1;
    public float damagePerSecond = 0;
    public float duration = 0;

    public RedMechEffect clone()
    {
        return (RedMechEffect)this.MemberwiseClone();
    }
}

public class RedMechAI : MonoBehaviour
{
    public RedMechStats stats = new RedMechStats();
    public Queue<Vector2> path = new Queue<Vector2>();
    public List<RedMechEffect> effects = new List<RedMechEffect>();
    ...
    void Update()
    {
        ...
        // Process Effects
        foreach (RedMechEffect effect in effects)
        {
