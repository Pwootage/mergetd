...
[Serializable]
public class RedInfantryEffect
{
    public float slowMultiplier = 1;
    public float damagePerSecond = 0;
    public float duration = 0;

    public RedInfantryEffect clone()
    {
        return (RedInfantryEffect)this.MemberwiseClone();
    }
}

public class RedInfantryAI : MonoBehaviour
{
    public RedInfantryStats stats = new RedInfantryStats();
    public Queue<Vector2> path = new Queue<Vector2>();
    public List<RedInfantryEffect> effects = new List<RedInfantryEffect>();
    ...
    void Update()
    {
        ...
        // Process Effects
        foreach (RedInfantryEffect effect in effects)
        {
